    ...
    const handleListTicket = async () => {
        ...
        try {
            ...
            const hash = await writeContractAsync({
                ...
                args: [BigInt(selectedTicket), priceInWei, attestation],
            });
            ...
            } else if (error.message && error.message.includes("Seller not verified")) {
                toast.error("You need to be verified (KYC) to resell tickets.");
                // Could redirect to KYC page here
            } else {
                ...
                <div className="mb-8">
                    ...
                    <div className="mt-4 flex items-center justify-between bg-white p-4 rounded-lg shadow-sm">
                        <div>
                            ...
                            <p className="text-sm text-gray-500">You must be verified to list tickets.</p>
                        </div>
                        <KYCFlow onVerified={() => refetchIdentity()} />
                    </div>
                </div>
                                        ...
                                        <CardHeader className="p-0">
                                            <div className="bg-gray-200 border-2 border-dashed rounded-xl w-full h-48 flex items-center justify-center">
                                                <img
                                                    ...
                                                    onError={(e) => {
                                                        (e.target as HTMLImageElement).src = 'https://via.placeholder.com/400x200?text=Ticket+Image';
                                                    }}
                                                />
                                            </div>
                                        </CardHeader>
                                ...
                                <CardContent className="space-y-6">
                                    ...
                                    <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                                        ...
                                        <ul className="text-sm text-blue-700 list-disc list-inside space-y-1">
                                            ...
                                            <li><strong>KYC Required:</strong> You must be an AI-verified seller.</li>
                                        </ul>
                                    </div>
