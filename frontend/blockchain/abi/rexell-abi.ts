export const contractAddress = (process.env.NEXT_PUBLIC_REXELL_ADDRESS as `0x${string}`) || "0x86167Ec889b0418c18A0b6eFBDA77D89e8c5861B";
export const rexellAbi = [
  ...
  {
    "inputs": [],
    "name": "getAllApprovedResaleTickets",
    "outputs": [
      {
        "components": [
          {
        ...
        "internalType": "struct Rexell.ResaleRequest[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
    ...
    "outputs": [
      {
        ...
        "internalType": "struct Rexell.Comment[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
  ...
  },
  {
    ...
    "name": "getEventOrganizerForToken",
    "outputs": [
      {
        "internalType": "address",
        "name": "",
  ...
  },
  {
    ...
    "name": "getOrganizerResaleRequests",
    "outputs": [
      {
        "components": [
          {
  ...
  },
  {
    ...
    "name": "getTicketOwnershipHistory",
    "outputs": [
      {
        "internalType": "address[]",
        "name": "",
