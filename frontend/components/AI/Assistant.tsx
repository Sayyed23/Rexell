    ...
    return (
        <>
            ...
            <button
                ...
                onClick={() => setOpen((o) => !o)}
                className="fixed bottom-20 right-4 sm:bottom-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-purple-600 text-white shadow-lg hover:bg-purple-700"
            >
            ...
            {open && (
                <div className="fixed bottom-36 right-4 sm:bottom-24 z-50 flex h-[28rem] w-[22rem] max-w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-xl border bg-white shadow-2xl">
                    <div className="flex items-center gap-2 bg-purple-600 px-4 py-3 text-white">
                            ...
                            <div className="space-y-1 pt-2">
                                {SUGGESTIONS.map((s) => (
                                    <button
                                        key={s}
                                        onClick={() => send(s)}
                                        className="block w-full rounded-md border border-purple-200 bg-purple-50 px-3 py-1.5 text-left text-xs text-purple-800 hover:bg-purple-100"
                                    >
                                        {s}
                                    </button>
                                ))}
                    ...
                    >
                        <input
                            ...
                            className="flex-1 rounded-md border px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-purple-400"
                        />
                        <button
                            type="submit"
